...
<section id="skills" class="max-w-4xl mx-auto px-6 py-12 border-b border-black/10 dark:border-white/10 transition-colors duration-300">
  <h2 class="font-mono text-xs text-gray-500 mb-6">Technical Arsenal</h2>
