<section id="about" class="max-w-4xl mx-auto px-6 py-12 border-b border-black/10 dark:border-white/10 grid grid-cols-1 md:grid-cols-4 gap-4 transition-colors duration-300">
  <div class="font-mono text-xs text-gray-500 pt-1">
    Context
  </div>
